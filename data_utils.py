...
raw_data_path_twitter_gender = './data/twitter_gender_data.csv'
raw_data_path_email_spam = './data/email_spam_data.csv'
...
def load_email_spam_data(from_cache=False):
    return
...
def load(data_name, *args, **kwargs):
    load_fn_map = {
        ...
        'email_spam_data': load_email_spam_data,
